#!/usr/bin/env python3
"""
Corrected Earth Mover Distance (EMD) Analysis
==============================================
Analyzes density distribution evolution across trajectories for all three datasets:
- lagrangebench_dataset_TGV (uses frame_XXXXX structure)
- SFBC_dataset_II (uses simulationExport/XXXXX structure)  
- SFBC_TGV (uses simulationExport/XXXXX structure)
...
class CorrectedEMDAnalyzer:
    """Corrected EMD analysis for fluid simulation datasets"""
    ...
    def __init__(self, base_path="/home/yusuf/Physics_Emulators_using_Continuous_Convolutions/data/SFBC"):
        ...
        self.datasets = {
            'lagrangebench_TGV': {
                ...
                'color': '#1f77b4',
                'data_structure': 'simulation'  # Uses simulationExport/XXXXX (same as SFBC)
            },
            'SFBC_dataset_II': {
    ...
    def load_trajectory_data(self, file_path, data_structure):
        ...
        try:
            with h5py.File(file_path, 'r') as f:
                ...
                if data_structure == 'frame':
                    # LagrangeBench format: frame_XXXXX
                ...
                elif data_structure == 'simulation':
    ...
    def run_comprehensive_analysis(self):
        ...
        print("🚀 Starting Corrected Comprehensive EMD Analysis")
        print("=" * 60)
    ...
    def create_summary_analysis(self, all_results):
        ...
        results_path = self.output_dir / 'corrected_emd_analysis_results.csv'
        df.to_csv(results_path, index=False)
        print(f"\n💾 Detailed results saved: {results_path}")
        
        # Create summary table
        print(f"\n📋 CORRECTED EMD ANALYSIS SUMMARY")
        print("=" * 80)
    ...
    def create_comparison_plots(self, df):
        ...
        plt.tight_layout()
        plot_path = self.output_dir / 'corrected_emd_comparison_barplot.png'
        ...
        plt.tight_layout()
        evolution_path = self.output_dir / 'corrected_emd_evolution_patterns.png'
...
def main():
    ...
    print("🌊 Corrected Comprehensive EMD Analysis for Fluid Simulation Datasets")
    print("=" * 70)
    
    analyzer = CorrectedEMDAnalyzer()
